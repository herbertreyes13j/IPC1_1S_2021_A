...
function cargar(){
    ...
    if (file) {
        ...
        reader.onload = function (evt) {
            ...
            fetch('http://34.67.203.10:5000/carga', {
            method: 'POST',
            headers,
...
function eliminar(libro,autor){
    ...
    fetch('http://34.67.203.10:5000/libros/'+libro+'/'+autor,{
        method:'DELETE'
    })
    .then(res => res.text())
    .then(res=> {
...
function agregarlibro(){
  ...
  fetch('http://34.67.203.10:5000/libros', {
    method: 'POST',
    headers,
    body: `{
        "titulo":"${titulo.value}",
...
fetch('http://34.67.203.10:5000/obtenerusuarios')
.then(response => response.json())
.then(data =>{
    var i;
